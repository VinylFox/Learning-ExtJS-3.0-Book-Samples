...
Colin Ramsay & Steve "Cutter" Blades - published by Packt Publishing. ISBN 13: 978-1-849511-20-9

https://www.packtpub.com/earning-ext-js-3-0-for-building-dynamic-desktop-style-user-interfaces/book

Or if that URL is just too ridiculous for you... 
...
If the database examples are to be used, then a separate '/cfg/' folder should also be created in 
